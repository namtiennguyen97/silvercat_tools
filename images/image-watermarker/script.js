(function () {
    ...
    const localDict = {
        vi: {
            ...
            'drop-desc': 'Hỗ trợ định dạng JPG, PNG, WebP',
            'lbl-wm-type': 'Loại Watermark',
            'type-text': 'Văn Bản (Text)', 'type-logo': 'Logo (Ảnh)',
            'lbl-text-content': 'Nội dung chữ', 'lbl-font': 'Phông chữ', 'lbl-color': 'Màu sắc',
            'lbl-upload-logo': 'Tải Logo Lên', 'btn-select-logo': 'Chọn Logo Image',
            'logo-no-file': 'Chưa chọn logo',
            'lbl-size': 'Kích thước (%)', 'lbl-opacity': 'Độ mờ (Opacity)', 'lbl-rotation': 'Xoay (Góc)',
            'lbl-position': 'Vị trí (Góc bố cục)',
            'btn-sample': 'Tải Ảnh Mẫu (Sample)',
            'preview-header': 'Kết Quả Xem Trước',
            'no-image': 'Chưa có hình ảnh',
            'placeholder-preview-text': 'Kéo thả hình ảnh vào để bắt đầu xem thử',
            'queue-title': 'Danh sách hàng đợi',
            'btn-clear': 'Xóa Hết', 'btn-download-all': 'Tải Về', 'btn-download-all-text': 'Tải Về Tất Cả',
