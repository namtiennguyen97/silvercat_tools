(function () {
    ...
    const localDict = {
        vi: {
            ...
            'compare-subtitle': 'Compare 2 text or code files and view differences in a visual GitHub-style diff. Supports side-by-side and unified views, ignore whitespace or case sensitivity.',
            'lbl-original': 'Original Text (A)',
            'lbl-modified': 'New Text (B)',
            'btn-upload': 'Tải file',
            'btn-clear': 'Clear',
            'btn-swap': 'Hoán đổi',
            ...
            'stat-added': 'thêm',
            'stat-removed': 'deleted',
            'stat-unchanged': 'giữ nguyên',
            'msg-identical': 'The two texts are completely identical.',
            'msg-empty-inputs': 'Please enter or upload content for both fields.',
            'msg-too-large': 'Text too large (>2500 lines per side). Please split to compare.',
            'meta-lines-single': '{n} dòng',
            'ph-input-a': 'Paste text or upload the original file here...',
            'ph-input-b': 'Paste text or upload the modified file here...'
        },
        en: {
