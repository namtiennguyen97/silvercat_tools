...
const localDictionary = {
    vi: {
        ...
        'dropzone-video-support': 'Supports MP4, WebM, QuickTime (MOV), AVI, MKV formats... 100% secure browser-side processing.',
        'info-name': 'Tên file:',
        'info-size': 'File size:',
        ...
        'lbl-audio-quality': 'Audio Quality (Audio Bitrate):',
        'lbl-gif-fps': 'Khung hình/giây (FPS):',
        'lbl-gif-scale': 'Image size:',
        'lbl-video-resolution': 'Output resolution:',
        'btn-select-different': 'Select different video',
        'btn-start-transcode': 'Start Conversion',
        'transcoding-title': 'Đang xử lý video...',
        'transcoding-desc': 'Please do not close your browser. Processing happens 100% offline on your computer.',
        ...
        'info-target-size': 'New file size:',
        ...
        'feat-speed-desc': 'Leveraging Web Audio API and hardware-accelerated Canvas for audio extraction and GIF compression in seconds.',
        'feat-allinone-title': 'Convenient Multi-format',
        'feat-allinone-desc': 'Full support for audio formats (MP3, WAV, AAC, FLAC), animated image creation (GIF), and packaging in popular video standards (MP4, WEBM, MOV, AVI, MKV).',
        'cat-audio': 'Audio',
        'cat-image': 'Image',
        'cat-video': 'Video',
        'search-format-placeholder': 'Search format...',
        'back-link': 'Back to tools collection',
        'loading-text': 'Loading tool...',
        'phase-init': 'Khởi tạo tài nguyên...',
        'phase-decode': 'Decoding audio stream...',
        'phase-encode': 'Đóng gói header tệp...',
        'phase-render': 'Extracting and rendering frames...',
